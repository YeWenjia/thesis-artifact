...
Definition exp_mutind :=
  ...
  exp_ind' H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 .

Scheme exp_rec' := Induction for exp Sort Set.

Definition exp_mutrec :=
  fun H1 H2 H3 H4 H5 H6 H7 H8 H9  H10 H11 H12  H13 H14  H15  =>
  exp_rec' H1 H2 H3 H4 H5 H6 H7 H8 H9  H10 H11 H12 H13 H14  H15  .
...
Fixpoint close_exp_wrt_exp_rec (n1 : nat) (x1 : var) (e1 : exp) {struct e1} : exp :=
  match e1 with
    ...
    | e_add => e_add
    | e_addl i5 =>  e_addl i5 
    | e_fval e2 => e_fval (close_exp_wrt_exp_rec n1 x1 e2)
  end.
...
Inductive degree_exp_wrt_exp : nat -> exp -> Prop :=
 ...
 | degree_wrt_exp_e_fval : forall n1 e1,
    degree_exp_wrt_exp n1 e1 ->
    degree_exp_wrt_exp n1 (e_fval e1)
.
...
Definition degree_exp_wrt_exp_mutind :=
  fun H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14  H15  =>
  degree_exp_wrt_exp_ind' H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15  .
...
Inductive lc_set_exp : exp -> Set :=
  ...
  | lc_set_e_fval : forall e1,
    lc_set_exp e1 ->
    lc_set_exp (e_fval e1)
.
